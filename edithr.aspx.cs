...
namespace HRPAYROLL
{
    public partial class edithr : System.Web.UI.Page
    {
        ...
        {
            string mailid = Session["hredit"].ToString();
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from hr where [email id]= '" + mailid + "'", con);
            ...
            while(sdr.Read())
            {
               ...
               hrid.Value=  sdr["Hr id"].ToString();
               depart.Value= sdr["name of department"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("update Hr set [name of department]='" + DEPART + "',[fname]='" + FNAME + "',[lname]='" + LASNAME + "',[email id]='" + EMAIL + "',[mobile number]='" + MOBILE + "',[degination]='" + DEGI + "',[salary]='" + SALARY + "',[date of joining]='" + JOIN + "',[date of birth]='" + DATE + "',[gender]='" + gender + "'where [Hr id]='" + HRID + "'  ", con);
