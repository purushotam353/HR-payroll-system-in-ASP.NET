<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="HRLOGIN.aspx.cs" Inherits="HRPAYROLL.HRLOGIN" %>
        ...
        <div class="col-md-6 col-md-offset-3">
          <div class="panel panel-primary">
           <div class="panel-heading">
               <div class="panel-title">WELCOME TO HR LOGIN PANNEL</div>
                </div>
                ...
                <div class="panel-footer">
                    <asp:Button ID="lghr" runat="server" Class="btn btn-primary" Text="Submit" OnClick="lghr_Click"/>
