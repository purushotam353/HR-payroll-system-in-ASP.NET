<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ADMINLOGIN.aspx.cs" Inherits="HRPAYROLL.ADMINLOGIN" %>
        ...
        <div class="col-md-6 col-md-offset-3">
          <div class="panel panel-primary">
           <div class="panel-heading">
               <div class="panel-title">WELCOME TO ADMIN LOGIN PANNEL</div>
                </div>
                ...
                <div class="panel-footer">
                    ...
                    <asp:Button ID="lgadmin" runat="server" Class="btn btn-primary" Text="submit" OnClick="lgadmin_Click" />
