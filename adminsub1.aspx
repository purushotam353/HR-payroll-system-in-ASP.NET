<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN.Master" AutoEventWireup="true" CodeBehind="adminsub1.aspx.cs" Inherits="HRPAYROLL.adminsub1" %>
        ...
        $(document).ready(function () {
            ...
            $("#<%=depart.ClientID%>").on('blur', function () {
                ...
                if ($("#<%=depart.ClientID%>").val().length == 0) {
                    ...
                    document.getElementById("dname").innerHTML = "enter department name";
                }
            ...
            $("#<%=lasname.ClientID%>").on('blur', function () {
                ...
                if ($("#<%=lasname.ClientID%>").val().length == 0) {
                    ...
                    document.getElementById("ln").innerHTML = "enter lastname field";
                }
        ...
        <div class="col-md-6 col-md-offset-3">
          <div class="panel panel-primary">
           <div class="panel-heading">
               <div class="panel-title">Register a New Hr Person</div>
                </div>
                ...
                <div class="panel-body">
                     ...
                     <label>Hr Id:</label>
                         <input type="text" runat="server" class="form-control" name="abhi" id="hrid" placeholder="HR ID*" disabled="disabled" />
                         </div>  
                    <div class="form-group">
