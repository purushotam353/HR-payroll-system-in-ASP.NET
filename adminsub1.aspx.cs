...
namespace HRPAYROLL
{
    public partial class adminsub1 : System.Web.UI.Page
    {
        string pass = "";
        string loginid = "";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                if (fileName.EndsWith("JPG") || fileName.EndsWith("jpg") || fileName.EndsWith("gif") || fileName.EndsWith("png"))
                {
                    ...
                    FileUpload1.PostedFile.SaveAs(Server.MapPath("~/profile pic/hr profile/") + fileName);
                    ...
                    if (HRID != "" && DEPART != "")
                    {
                        ...
                        if (chkmail() == 0)
                        {
                            ...
                            SqlCommand cmd = new SqlCommand("insert into Hr values('" + HRID + "','" + DEPART + "','" + FNAME + "','" + LASNAME + "','" + EMAIL + "','" + MOBILE + "','" + DEGI + "','" + SALARY + "','" + JOIN + "','" + DATE + "','" + gender + "','" + fileName + "')", con);
                            SqlCommand cmd1 = new SqlCommand("insert into login values ('" + loginid + "','" + pass + "','hrlogin')", con);
        ...
        public int chkmail()
        {
            ...
            SqlCommand cmd = new SqlCommand("select count(* ) from  Hr where [email id] ='" + email.Value + "'", con);
       ...
       return 1;
         ...
         public string gethrid()
        {
           ...
           string totalid=""; 
            string stmt = "SELECT COUNT(*) FROM Hr";
            int count = 0;
